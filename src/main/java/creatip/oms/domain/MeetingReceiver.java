...
@Entity
@Table(name = "meeting_receiver")
public class MeetingReceiver implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MeetingReceiver)) {
            return false;
        }
        return id != null && id.equals(((MeetingReceiver) o).id);
    }
}
