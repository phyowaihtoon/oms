...
import creatip.oms.service.mapper.DocumentHeaderMapper;
...
public class DocumentHeaderServiceImpl implements DocumentHeaderService {
    ...
    public boolean checkDuplication(DocumentHeaderDTO documentHeaderDTO) {
        ...
        long duplicateCount =
            this.documentHeaderRepository.checkDuplication(documentHeaderDTO.getMetaDataHeaderId(), documentHeaderDTO.getFieldValues());

        if (duplicateCount > 0) isDuplicate = true;
