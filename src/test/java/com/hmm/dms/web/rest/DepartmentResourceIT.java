...
import com.hmm.dms.repository.DepartmentRepository;
import com.hmm.dms.service.dto.DepartmentDTO;
import com.hmm.dms.service.mapper.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().departmentName(DEFAULT_DEPARTMENT_NAME).delFlag(DEFAULT_DEL_FLAG);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().departmentName(UPDATED_DEPARTMENT_NAME).delFlag(UPDATED_DEL_FLAG);
        return department;
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).delFlag(UPDATED_DEL_FLAG);
        ...
        assertThat(testDepartment.getDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
    }
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).delFlag(UPDATED_DEL_FLAG);
