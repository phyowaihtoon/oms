package creatip.oms.security.jwt;

import static org.assertj.core.api.Assertions.assertThat;

import creatip.oms.security.AuthoritiesConstants;
import creatip.oms.security.jwt.JWTFilter;
import creatip.oms.security.jwt.TokenProvider;
...
class JWTFilterTest {
    ...
    void testJWTFilter() throws Exception {
        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(
            "test-user",
            "test-password",
            Collections.singletonList(new SimpleGrantedAuthority(AuthoritiesConstants.APPLICATION_USER))
        );
