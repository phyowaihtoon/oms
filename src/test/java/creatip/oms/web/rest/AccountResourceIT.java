...
import static creatip.oms.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import creatip.oms.IntegrationTest;
import creatip.oms.config.Constants;
import creatip.oms.domain.User;
import creatip.oms.repository.AuthorityRepository;
import creatip.oms.repository.UserRepository;
...
import creatip.oms.service.dto.PasswordChangeDTO;
import creatip.oms.service.dto.UserDTO;
import creatip.oms.web.rest.AccountResource;
import creatip.oms.web.rest.vm.KeyAndPasswordVM;
import creatip.oms.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        authorities.add(AuthoritiesConstants.SYSTEM_USER);
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.authorities").value(AuthoritiesConstants.SYSTEM_USER));
    }
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.APPLICATION_USER));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.APPLICATION_USER));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.APPLICATION_USER));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.SYSTEM_USER));
        ...
        assertThat(userDup.get().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.APPLICATION_USER).get());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.SYSTEM_USER));
