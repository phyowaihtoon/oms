...
import creatip.oms.domain.Authority;
...
import creatip.oms.service.mapper.UserMapper;
import creatip.oms.web.rest.UserResource;
...
@WithMockUser(authorities = AuthoritiesConstants.SYSTEM_USER)
@IntegrationTest
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(Collections.singleton(AuthoritiesConstants.APPLICATION_USER));
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.APPLICATION_USER));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.APPLICATION_USER);
    }
    ...
    void testUserToUserDTO() {
        ...
        authority.setName(AuthoritiesConstants.APPLICATION_USER);
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.APPLICATION_USER);
    ...
    void testAuthorityEquals() {
        ...
        authorityB.setName(AuthoritiesConstants.SYSTEM_USER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityA.setName(AuthoritiesConstants.APPLICATION_USER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.APPLICATION_USER);
